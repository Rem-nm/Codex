...
- 检查 gh 已安装并已认证；
- 使用 GitHub 插件规定的提交、推送、Draft PR 和合并流程；
...
1. 发布前复核文档、diff、敏感信息和只修改 Ss2022/ 范围；
2. 按 GitHub 插件流程有意提交、推送并创建 PR；
3. 检查 PR 状态和 CI，通过后合并；
4. 合并后记录最终提交、PR 和安装入口校验值。
